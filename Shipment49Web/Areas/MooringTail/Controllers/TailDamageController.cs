...
namespace Shipment49Web.Areas.MooringTail
{
    ...
    [ErrorClass]
    public class TailDamageController : BaseController
    {
       ...
       // public static string VesselID;
           ...
           int VesselID = Convert.ToInt32(Session["VesselSessionID"].ToString());
            using (ShipmentContaxt sc1 = new ShipmentContaxt())
            {
                ...
                var ilist = new ShipmentContaxt()
                     .MultipleResults("[dbo].[GetDamageRope]  1,'" + VesselID + "'")
                   .With<RopeDamage>()
                   .Execute();
        ...
        public ActionResult Delete(int Id)
        {
            try
            {
                ...
                SqlDataAdapter adp = new SqlDataAdapter("update RopeDamageRecord set IsActive='False' where Id =" + Id + " and RopeTail = 1 and VesselID='" + vesselid + "' ", con);
