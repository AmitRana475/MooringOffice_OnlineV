...
namespace Shipment49Web.Areas.MooringLine.Controllers
{
    ...
    [ErrorClass]
    public class MooringLineController : BaseController
    {
        ...
        public ActionResult Index()
        {
          int  VesselID = Convert.ToInt32(Session["VesselSessionID"].ToString());
            using (ShipmentContaxt sc1 = new ShipmentContaxt())
            {
                ...
                var ss = model.MooringLineList.Count();
        ...
        [PreventSpam("addmooringinfo", 3, 1)]
        public ActionResult addmooringinfo(MooringRopeDetail mropdtls, HttpPostedFileBase file)
        {
            using (MorringOfficeEntities entities = new MorringOfficeEntities())
            {
                ...
                if (mropdtls.Id == 0)
                {
                    var duplicatecheck = entities.MooringRopeDetails.Where(x => x.UniqueID == mropdtls.UniqueID && x.RopeTail == 0 && x.VesselID==vesselid).Count();
                    ...
                    if (duplicatecheck == 0)
                    {
                        ...
                        if (mropdtls.IsRopeInstalled == "Yes")
                        {
                            ...
                            else
                            {
                                ...
                                addinDB.InspectionDueDate = CommonClass.updateinspecionduedate(addinDB.InstalledDate, mropdtls.RopeTypeId, mropdtls.ManufacturerId);
                            }
                        }
                        ...
                        if (file != null)
                        {
                            ...
                            if (str1.Contains(FileExtension))
                            {
                                ...
                                CommonClass.InsertRopeAttachment(idPk, pth, rpid, 0, "Line",0, VesselID);
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            if (mropdtls.IsRopeInstalled == "Yes")
                            {
                                ...
                                SqlDataAdapter adpp1 = new SqlDataAdapter("select MAX(AssignedDate) as AssignedDate  from AssignRopeToWinch where RopeId=" + mropdtls.Id + " and IsActive=1 and RopeTail=0 and VesselId='" + VesselID + "'", con);
                        ...
                        SqlDataAdapter adpp2 = new SqlDataAdapter("select MAX(SplicingDoneDate) as SplicingDoneDate from RopeSplicingRecord where RopeId=" + mropdtls.Id + " and IsActive=1 and RopeTail=0 and VesselId='" + VesselID + "'", con);
                        ...
                        SqlDataAdapter adpp3 = new SqlDataAdapter("select MAX(DamageDate) as DamageDate from ropedamagerecord where RopeId=" + mropdtls.Id + " and IsActive=1 and RopeTail=0 and VesselId='" + VesselID + "'", con);
                        ...
                        SqlDataAdapter adpp4 = new SqlDataAdapter("select MAX(CroppedDate) as CroppedDate from RopeCropping where RopeId=" + mropdtls.Id + " and IsActive=1 and RopeTail=0 and VesselId='" + VesselID + "'", con);
                    ...
                    if (obj != null)
                    {
                        ...
                        if (mropdtls.IsRopeInstalled == "Yes")
                        {
                            ...
                            else
                            {
                                ...
                                obj.InspectionDueDate = CommonClass.updateinspecionduedate(mropdtls.InstalledDate, mropdtls.RopeTypeId, mropdtls.ManufacturerId);
                            }
                        }
                        if (mropdtls.IsRopeInstalled == "No")
                        {
                    ...
                    if (file != null)
                    {
                        ...
                        if (str1.Contains(FileExtension))
                        {
                            ...
                            CommonClass.UpdateRopeAttachment(idPk, pth, obj.RopeId, 0, "Line",0, VesselID);
        ...
        public JsonResult DetailCheck(int RopeId)
        {
            ...
            return Json( new { RopeConstruction = lineD.RopeConstruction,
                ...
                rptype = ropetype}, JsonRequestBehavior.AllowGet);
        }
    }
}