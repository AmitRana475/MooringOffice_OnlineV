...
namespace Shipment49Web.Areas.MooringLine.Controllers
{
    ...
    [ErrorClass]
    public class LineCroppingController : BaseController
    {
       ...
       // public static int VesselID { get; set; }
           ...
           int VesselID = Convert.ToInt32(Session["VesselSessionID"].ToString());
            using (ShipmentContaxt sc1 = new ShipmentContaxt())
            {
                ...
                var ilist = new ShipmentContaxt()
                     .MultipleResults("[dbo].[GetRopeCropping]  0,'" + VesselID + "'")
        ...
        [HttpPost]
        [PreventSpam("addlinecropping", 3, 1)]
        ...
        public JsonResult GetWinchlocation(int Id)
        {
            ...
            else
            {
                ...
                return Json(new { Result = true, outboard = "", asswinch = "", location = "", outboard1 = "", ttlcrpd = ttlcrpdrope }, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult Installdatecheck(string dtvalue, int RopeId)
        {
            ...
            {
                string msg = "Cropping Date can not less than Line Installed date!";
        ...
        public ActionResult Delete(int Id)
        {
            try
            {
                ...
                try
                {
                    SqlDataAdapter adp1 = new SqlDataAdapter("update RopeCropping set IsActive='False' where Id =" + Id + " and RopeTail = 0 and VesselID='" + vesselid + "' ", con);
                    DataTable dt1 = new DataTable();
                    adp1.Fill(dt1);
