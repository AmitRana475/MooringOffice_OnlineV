...
namespace Shipment49Web.Areas.MooringLine.Controllers
{
    ...
    [ErrorClass]
    public class LineDiscardController : BaseController
    {
       ...
       //public static string VesselID;
           ...
           int VesselID = Convert.ToInt32(Session["VesselSessionID"].ToString());
            using (ShipmentContaxt sc1 = new ShipmentContaxt())
            {
                ...
                var ilist = new ShipmentContaxt()
                     .MultipleResults("[dbo].[GetRopeDiscardList]  0,'" + VesselID + "'")
        ...
        public ActionResult addlinediscard()
        {
            ...
            assR.MooringLineDiscardLists = CommonClass.MooringRopeDiscardListCommon(0,VesselID);
            return View(assR);
        }
        [HttpPost]
        [PreventSpam("addlinediscard", 3, 1)]
        public ActionResult addlinediscard(MooringRopeDetail rpdiscard)
        {
            ...
            try
            {
                ...
                CommonClass.SaveNotification(vesselid, mrRope.RopeId, notification, (int)NotificationAlertType.OutofService_discarded_Rope);
        ...
        public ActionResult Delete(int Id)
        {
            try
            {
                ...
                SqlDataAdapter adp = new SqlDataAdapter("update RopeDamageRecord set IsActive='False' where RopeId =" + Id + " and RopeTail = 0 and VesselID='" + vesselid + "' ", con);
                DataTable dt = new DataTable();
                adp.Fill(dt);
                ...
                try
                {
                    ...
                    if (dt5.Rows.Count > 0)
                    {
                        ...
                        TempData["Error"] = "You can not delete this record ! Firstly remove from Line Disposal";
                        return RedirectToAction("Index");
                    }
                    else
                    {
