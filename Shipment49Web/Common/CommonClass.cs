       ...
       // public static string VesselSessionID { get; set; }
        ...
        public static void LoggedIPAddressesRemove()
        {
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
                ...
                using (SqlDataAdapter pp = new SqlDataAdapter("delete from RateLimit where CreatedOn < DATEADD(dd, 0, DATEDIFF(dd, 0, GETDATE())); ", connection))
                {
                    DataTable dd = new DataTable();
                    pp.Fill(dd);
                }
...
a.OutofServiceDate is null and a.DeleteStatus=0 and a.RopeTail=1 and a.VesselID = " + VesselID + " Group by b.MinimumRopes,b.MinimumRopeTails,a.VesselID";
        ...
        public static List<MooringRopeInspections> MooringInspectionList(string year, int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringTailInspections> MooringInspectionList1(string year, int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
                using (SqlCommand cmd = new SqlCommand("GetRopeInspection", con))
        ...
        public static List<MooringRopeInspection> AddLineInsList(int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringRopeInspection> EditLineInsList(int inspectionid, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringRopeDetail> MooringRopeDisposalListCommon(int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringRopeDetail> MooringRopeDiscardListCommon(int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringRopeDetail> MooringRopeDetailListCommon(int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringRopeDetail> MooringRopeDetailListResidual(int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MOperationBirthDetail> MooringOpListCommon(int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringRopeDetail> MooringRopeDetailListEndtoEnd(int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static List<MooringRopeDetail> MooringRopeDetailList(int ropetail, int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
        ...
        public static int NextNotiId(int VesselSessionID)
        {
            int notiid = 0;
            try
            {
        ...
        public static List<MooringWinchDetail> MooringWinchList(int VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
                using (SqlCommand cmd = new SqlCommand("select Id,AssignedNumber from MooringWinchDetail where IsActive=1 and VesselId='" + VesselSessionID + "' order by SortingOrder desc", con))
                {
        ...
        public static int NextInspectionId(int vesselid)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("select max(inspectionid) from mooringropeinspection where VesselID='" + vesselid + "'", con))
                    {
                        DataTable dt = new DataTable();
                        adp.Fill(dt);
                        if (dt.Rows.Count > 0)
        ...
        public static void InspectNotification(int RopeID, string NotiMsg, int NotiAlertType, int VesselSessionID)
        {
            int VesselID = VesselSessionID;
            using (MorringOfficeEntities context = new MorringOfficeEntities())
            {
                ...
                {
                    tblNotification noti = new tblNotification();
                    noti.Id = NextNotiId(VesselSessionID);
                    noti.VesselId = VesselID;
                    noti.Acknowledge = false;
                    noti.AckRecord = "Not yet acknowledged";
        ...
        public static void WinchrotationSetting_and_Notifications(int VesselSessionID)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
...
where a.VesselID = " + VesselSessionID + "";   // and R.RopeId = " + Ropeid + "
                                ...
                                using (SqlDataAdapter pp1 = new SqlDataAdapter("select * from tblWinchRotationSetting where VesselID = " + VesselSessionID + " and mooringropetype = " + RopeTypeId + " and ManufacturerType= " + ManufacturerId + " and LeadFrom='" + Lead + "'", con))
                                {
                                    ...
                                    if (WRSetting.Rows.Count > 0)
                                    {
                                        ...
                                        if (CurrentDate >= AssignedDateAppro && CurrentDate < AssignedDateExceed)
                                        {
                                            ...
                                            InspectNotification(ropeid, winchrotation, NotiAlertType,VesselSessionID);
                                            MA++;
        ...
        public static DateTime? LEqInspectionDate(DateTime DateInstalled, int LEType)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("select * from tblLooseEquipInspectionSetting where EquipmentType=" + LEType + "", con))
                    {
                        DataTable dt = new DataTable();
                        adp.Fill(dt);
                        if (dt.Rows.Count > 0)
        ...
        public static string NotificationCounter(string VesselSessionID)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
                string counter = "";
...
NotificationAlertType = 17 or NotificationAlertType = 18 or NotificationType = 17 or NotificationType = 18) and isactive = 1 and VesselID = @VesselId";
        ...
        public static void DeleteNotificationsRopeID( int VesselID, int? RopeId, int NotificationType)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    string sqry = "delete from tblNotification where VesselID=@VesselID and RopeId=@RopeId and NotificationType=@NotificationType";
                    using (SqlDataAdapter adp = new SqlDataAdapter(sqry, con))
                    {
                        // adp.SelectCommand.CommandType = CommandType.StoredProcedure;
                        RopeId = RopeId == null ? 0 : RopeId;
                        adp.SelectCommand.Parameters.AddWithValue("@RopeId", RopeId);
                        adp.SelectCommand.Parameters.AddWithValue("@NotificationType", NotificationType);
        ...
        public static void InsertTrAtt(int id, string attachmentname, string attachmentpath, int VesselSessionID)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("InsertTrainginAttachment", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public static void InsertAtuoLogout(string email, string myip)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("InsertAutoLogout", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public static void DeleteTrAtt(int id, int VesselSessionID)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("DeleteTrngAtt", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
                        adp.SelectCommand.Parameters.AddWithValue("@Id", id);
                        adp.SelectCommand.Parameters.AddWithValue("@VesselId", VesselSessionID);
        ...
        public static void CheckEmailAuto(string email)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("EmailcheckAuto", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
                        adp.SelectCommand.Parameters.AddWithValue("@Email", email);
        ...
        public static int MaxID(int maxid, int VesselSessionID)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("MaxIdGet", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public static void lead_check(int? ropeid, DateTime? assigneddate, int? winchid, int vesselid)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
            {
                            ...
                            using (SqlDataAdapter adp = new SqlDataAdapter("select * from MOUsedWinchTbl where ropeid=" + ropeid + " and VesselID = '" + vesselid + "'", con))
                            {
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    //if (dd1.Rows.Count > 0)
                                    {
                                        ...
                                        if (rnghrs != 0)
                                        {
                                            var IdPK = ((from asn in context.WinchRotations.Where(x => x.VesselID == vesselid) select (int?)asn.Id).Max() ?? 0) + 1;


                                            SqlDataAdapter pp = new SqlDataAdapter("INSERT INTO WinchRotation (Id, RopeId, AssignedDate, WinchId,Lead,RunningHours,IsActive,VesselID)VALUES(" + IdPK + ", " + ropeid + ", '" + assigneddate + "', " + winchid + ",'" + lead + "','" + rnghrs + "','" + true + "','" + vesselid + "' ); ", con);
                                            DataTable dd = new DataTable();
                                            pp.Fill(dd);
        ...
        //        try
        //        {
        //            int Pk_WinchRotation = 0;
        //            // SqlDataAdapter adp = new SqlDataAdapter("SELECT IDENT_CURRENT('Notifications') + IDENT_INCR('Notifications') as Notiid", con);
        //            using (SqlDataAdapter adp = new SqlDataAdapter("select MAX(Id) + 1 as id    from  WinchRotation where VesselID=" + vesselid + "", con))
        //            {
        //                DataTable dt = new DataTable();
        //                adp.Fill(dt);
        //                 Pk_WinchRotation = Convert.ToInt32(dt.Rows[0][0]);
        ...
        //                                    SqlDataAdapter pp = new SqlDataAdapter("INSERT INTO WinchRotation (Id,RopeId, AssignedDate, WinchId,Lead,RunningHours,IsActive,VesselID)VALUES( "+Pk_WinchRotation+" , " + ropeid + ", '" + assigneddate + "', " + winchid + ",'" + lead + "','" + rnghrs + "','" + true + "','" + vesselid + "' ); ", con);
        //                                    DataTable dd = new DataTable();
        //                                    pp.Fill(dd);
        ...
        public static DateTime? updateinspecionduedate(DateTime? installdate, int? ropetypeid, int? manufacid)
        {
           // SqlConnection con = ConnectionBulder.con;
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("select * from tblRopeInspectionSetting where MooringRopeType=" + ropetypeid + " and ManufacturerType=" + manufacid + "", con))
                    {
                        DataTable dt = new DataTable();
                        adp.Fill(dt);
                        if (dt.Rows.Count > 0)
        ...
        public static DateTime? updateinspecionduedate1(DateTime? installdate, int? ropetypeid, int? manufacid)
        {
            // SqlConnection con = ConnectionBulder.con;
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("select * from tblRopeTailInspectionSetting where MooringRopeType=" + ropetypeid + " and ManufacturerType=" + manufacid + "", con))
                    {
                        DataTable dt = new DataTable();
                        adp.Fill(dt);
                        if (dt.Rows.Count > 0)
        ...
        public static void InsertRopeAttachment(int id,  string attachmentpath, int RopeId,int RopeTail,string LineResidual,int ResidualID, int VesselSessionID)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("InsertRopeAttachment", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
                        adp.SelectCommand.Parameters.AddWithValue("@Id", id);                     
                        adp.SelectCommand.Parameters.AddWithValue("@AttachmentPath", attachmentpath);
                        ...
                        adp.SelectCommand.Parameters.AddWithValue("@LineResidual", LineResidual);
                        adp.SelectCommand.Parameters.AddWithValue("@IsActive", true);
                        adp.SelectCommand.Parameters.AddWithValue("@DeleteStatus", false);
                        adp.SelectCommand.Parameters.AddWithValue("@ResidualID", ResidualID);
                        adp.SelectCommand.Parameters.AddWithValue("@VesselID", VesselSessionID);
                        DataTable dt = new DataTable();
                        adp.Fill(dt);
                    }
        ...
        public static Tuple<int, int,int> Getmaxid(int id, int RopeId,int Resid, int VesselSessionID)
        {
            int ID = 0;
            int ROPEID = 0;
            int ResID = 0;
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("GetMaxIds", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
                        adp.SelectCommand.Parameters.AddWithValue("@VesselID", VesselSessionID);
                        ...
                        ROPEID = Convert.ToInt32(dt.Tables[1].Rows[0][0]);
                        ResID = Convert.ToInt32(dt.Tables[2].Rows[0][0]);
                    }
                }
            }
            catch (Exception ex) { }

            return new Tuple<int, int, int>(ID, ROPEID, ResID);
        }

        public static void UpdateRopeAttachment(int id, string attachmentpath, int RopeId, int RopeTail, string LineResidual, int ResidualID, int VesselSessionID)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConnectionName].ConnectionString))
                {
                    using (SqlDataAdapter adp = new SqlDataAdapter("UpdateRopeAttachment", con))
                    {
                        adp.SelectCommand.CommandType = CommandType.StoredProcedure;
                        adp.SelectCommand.Parameters.AddWithValue("@Id", id);
                        adp.SelectCommand.Parameters.AddWithValue("@AttachmentPath", attachmentpath);
